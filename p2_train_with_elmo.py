...
# Set up log file
logging.basicConfig(
    filename=f"{os.getcwd()}/elmo-p2.log",
    filemode="a",
...
corpus = Corpus(sentences=list(golden_2.reviews), labels=list(golden_2.Judgement))
# Print corpus stats
...
if SAVE_MODEL:
    ...
    torch.save(model.state_dict(), f"{output_dir}/p2-elmo.bin")
